 ...
 */
$access_token = '233529522:AAG_vLBj2UaKXw66Helad1j7gVR4a-Z75EA';
...
switch($message) {
  ...
  case '/pogoda':
    ...
    $preload_text = 'Уточняю для вас погоду...' . $first_name . ' ' . $emoji['preload'] . ' Пожалуйста подождите...';
    sendMessage($chat_id, $preload_text);
    // API key для OpenWeatherMap.
    $apikey= '2f28d7e8c905ce6693fde840cf63bd78';
    // ID для города/района/местности (есть все города РФ).
    $id = '514734'; // Для примера: Петербург, север города.
